...
export const VoucherPayment = () => {
    ...
    const options = [
      ...
      const options2 =[
        {value:'Uploaded Vouchers', label:'Uploaded Vouchers'},
        {value:'Pending Vouchers', label:'Pending Vouchers'},
        {value:'Incorrect Vouchers', label:'Incorrect Vouchers'},
        {value:'Uploaded Payment Proof', label:'Uploaded Payment Proof'},
        {value:'Pending Payment Proof', label:'Pending Payment Proof'},
            ...
            <div className='col-lg-12'>
              <div className='list_qoute'>
                <ul>
                  ...
                  <li><Link>Overdue from Traveler</Link> </li>
                  <li><Link>Voucher/Payment-Proof Status</Link> </li>
                  <li><Link>Payment On-Hold</Link> </li>
